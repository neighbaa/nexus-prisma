...
export const generateRuntimeAndEmit = (dmmf, settings) => {
    ...
    // fs.remove(outputDir)
    const outPutDir = settings.data.output.directory === 'default' ? OUTPUT_SOURCE_DIR : settings.data.output.directory;
...
export const generateRuntime = (dmmf, settings) => {
    return [
        ModuleGenerators.JS.createModule({
            gentimeSettings: settings,
            esm: true,
