...
export const createModule = (dmmf, settings) => {
    return {
        fileName: 'index.d.ts',
        content: dedent `
...
`;
export const renderTypeScriptDeclarationForDocumentModels = (dmmf, settings) => {
 ...
 */
export const fieldTypeToGraphQLType = (field, settings) => {
